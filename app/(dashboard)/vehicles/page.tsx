...
export default async function VehiclesPage() {
  const [rows, driverOptions] = await Promise.all([
    listVehicles(),
  ...
  return (
    <ModulePage
      ...
      title="Автомобілі"
      description="Картки ТЗ з технічними характеристиками, нормативами розходу та сервісною книгою."
      actions={
        <VehicleFormDialog mode="create" driverOptions={driverOptions} />
      }
    >
      <VehiclesTable rows={rows} driverOptions={driverOptions} />
    </ModulePage>
  );
}
